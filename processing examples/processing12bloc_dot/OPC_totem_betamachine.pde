...
void setup_totem_led (String IpServer)
{
  setup_totem (IpServer, 72,24);
}

void setup_totem (String IPserveur, int gridwidth, int gridheight)
{
...
//  }
  ...
  // for this design
  opc = new OPC(this, IPserveur, 7890);
